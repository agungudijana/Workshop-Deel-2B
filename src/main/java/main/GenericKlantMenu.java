...
public class GenericKlantMenu { 

	private static final Logger logger =  LoggerFactory.getLogger(GenericKlantMenu.class);
	...
	public static void main(String[] args){
		...
		System.out.println("\t-----------------------------");
		System.out.println("\t Klant Domain (GENERIC DAO)  ");
		System.out.println("\t-----------------------------");
